...
const std::vector<std::vector<double>> test_data::marginal_distribution_2d = {{0.575187+0.889452+0.985531,0.846482+1+0.846482,0.985531+0.889452+0.575187},
                                                                              {0.575187+0.846482+0.985531,0.889452+1+0.889452,0.985531+0.846482+0.575187}};
